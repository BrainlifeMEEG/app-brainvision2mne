...
[![Run on Brainlife.io](https://img.shields.io/badge/Brainlife-bl.app.636-blue.svg)](https://doi.org/10.25663/brainlife.app.636)

## Documentation
Converts EEG `brainvision` files to MNE raw data, using `mne.io.read_raw_brainvision` function from MNE-python.

1) Input file is:
    * `eeg/brainvision` eeg data file
2) Ouput files are:
    * `meeg/mne/raw` eeg raw.fif data file
